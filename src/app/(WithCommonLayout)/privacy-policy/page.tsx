    ...
    <div className="flex items-center justify-center min-h-screen  px-4 my-26">
      <div className="max-w-2xl w-full p-8 border border-gray-300  rounded-2xl shadow-lg bg-white  transition-all duration-300">
        ...
        <p className="text-lg text-gray-600  text-center">
          ...
          <span className="font-semibold text-blue-400">MealHut</span> collects, uses, and protects your data.
        </p>

        <div className="mt-6 space-y-4 text-gray-600 ">
          <div className="p-4 border-l-4 border-blue-400 bg-gray-100  rounded-lg">
            <h3 className="text-xl font-semibold text-blue-400">1. Information We Collect</h3>
            <p className="mt-1">
          ...
          <div className="p-4 border-l-4 border-blue-400 bg-gray-100  rounded-lg">
            <h3 className="text-xl font-semibold text-blue-400">2. How We Use Your Data</h3>
            <p className="mt-1">
          ...
          <div className="p-4 border-l-4 border-blue-400 bg-gray-100  rounded-lg">
            <h3 className="text-xl font-semibold text-blue-400">3. Data Security</h3>
            <p className="mt-1">
          ...
          <div className="p-4 border-l-4 border-blue-400 bg-gray-100  rounded-lg">
            <h3 className="text-xl font-semibold text-blue-400">4. Third-Party Sharing</h3>
            <p className="mt-1">
          ...
          <div className="p-4 border-l-4 border-blue-400 bg-gray-100  rounded-lg">
            <h3 className="text-xl font-semibold text-blue-400">5. Your Rights</h3>
            <p className="mt-1">
