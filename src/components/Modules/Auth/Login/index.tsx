  ...
  return (
    <div className="w-full max-w-md mx-auto p-8 space-y-8 bg-white rounded-xl shadow-xl border border-gray-100">
      <div className="text-center">
        ...
        <h2 className="text-3xl font-extrabold text-blue-400 mb-2">Login</h2>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Button
            type="submit"
            className="w-full py-3 px-4 bg-blue-400 hover:bg-blue-500 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center"
          ...
          <div className="text-center mt-4">
            <p className="text-sm text-gray-600">
              ...
              <Link
                href="/register"
                className="font-medium text-blue-400 hover:text-blue-500 hover:underline transition-colors duration-200"
              >
                Register
              </Link>
            </p>
